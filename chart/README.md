...
| `image.tag`                      | Image tag/version                                                                                 | `"v1.2.4"`                                        |
...
| `serviceIDCacheTTL`              | Lifetime of cached service IDs (format: https://pkg.go.dev/time#ParseDuration, e.g., "1h", "30m") | `3384h` (3*47=141 days)                           |
